    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SalesStatistics.Data.SalesStatisticsContext> {
        ...
        protected override void Seed(SalesStatisticsContext context) {
            ...
            context.Set<SalesStatistic>().AddOrUpdate(ss => new { ss.Type1_ClassifierId, ss.Type2_ClassifierId, ss.ShipDate, ss.Type3_ClassifierId, ss.Type4_ClassifierId },
                new SalesStatistic[] {
                new SalesStatistic { Type1_ClassifierId="Classifier1Id2", Type2_ClassifierId = "Classifier2Id2", Type3_ClassifierId="Classifier3Id2", Type4_ClassifierId = "Classifier4Id2", ShipDate=DateTime.Parse("4/12/2018"), Amount=1},
                new SalesStatistic { Type1_ClassifierId="Classifier1Id2", Type2_ClassifierId = "Classifier2Id3", Type3_ClassifierId="Classifier3Id2", Type4_ClassifierId = "Classifier4Id3", ShipDate=DateTime.Parse("4/12/2018"), Amount=1},
                new SalesStatistic { Type1_ClassifierId="Classifier1Id1", Type2_ClassifierId = "Classifier2Id2", Type3_ClassifierId="Classifier3Id1", Type4_ClassifierId = "Classifier4Id2", ShipDate=DateTime.Parse("4/12/2018"), Amount=1},
                new SalesStatistic { Type1_ClassifierId="Classifier1Id5", Type2_ClassifierId = "Classifier2Id5", Type3_ClassifierId="Classifier3Id5", Type4_ClassifierId = "Classifier4Id5", ShipDate=DateTime.Parse("4/12/2018"), Amount=1},
                new SalesStatistic { Type1_ClassifierId="Classifier1Id1", Type2_ClassifierId = "Classifier2Id3", Type3_ClassifierId="Classifier3Id1", Type4_ClassifierId = "Classifier4Id3", ShipDate=DateTime.Parse("4/12/2018"), Amount=1},
                new SalesStatistic { Type1_ClassifierId="Classifier1Id7", Type2_ClassifierId = "Classifier2Id3", Type3_ClassifierId="Classifier3Id7", Type4_ClassifierId = "Classifier4Id3", ShipDate=DateTime.Parse("4/12/2018"), Amount=1},
                new SalesStatistic { Type1_ClassifierId="Classifier1Id3", Type2_ClassifierId = "Classifier2Id8", Type3_ClassifierId="Classifier3Id3", Type4_ClassifierId = "Classifier4Id8", ShipDate=DateTime.Parse("4/12/2018"), Amount=1},
                new SalesStatistic { Type1_ClassifierId="Classifier1Id1", Type2_ClassifierId = "Classifier2Id1", Type3_ClassifierId="Classifier3Id1", Type4_ClassifierId = "Classifier4Id1", ShipDate=DateTime.Parse("4/12/2018"), Amount=1},
            });
